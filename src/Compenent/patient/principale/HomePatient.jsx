        ...
        <div className="container py-5">
          <div className="row justify-content-start">
            <div className="col-lg-8 text-center text-lg-start" style={{ paddingTop: "50px" }}>
              <h4 className="d-inline-block text-primary text-uppercase border-bottom border-5" style={{ Color: 'black' }}> Bienvenue sur Doctor's Réservez vos rendez-vous en quelques clics. </h4>
              <h3 className="display-1 text-white mb-md-4" style={{ fontSize: "20px" }}>
Découvrez votre médecin idéal en un clin d'œil,<br />
               
Planifiez votre rendez-vous sans tracas ,<br />
